...
PROJECT_DIR="$SCRIPT_DIR/spoon-transformer"
OUTPUT_JAR="$SCRIPT_DIR/spoon-transformer.jar"

echo "=== Building Spoon Logger Transformer ==="
...
cp target/spoon-transformer-1.0.0.jar "$OUTPUT_JAR"
